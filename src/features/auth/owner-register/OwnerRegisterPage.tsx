    ...
    <main className="min-h-dvh bg-[linear-gradient(180deg,var(--bg-primary)_0%,color-mix(in_srgb,var(--bg-surface)_88%,white)_42%,color-mix(in_srgb,var(--bg-elevated)_85%,white)_100%)] px-4 py-3 text-[color:var(--fg-primary)] lg:px-6 lg:py-5">
      <div className="mx-auto flex min-h-[calc(100dvh-1.5rem)] w-full max-w-6xl flex-col lg:min-h-[calc(100dvh-2.5rem)]">
        ...
        <section className="relative flex flex-1 items-center py-3 lg:py-5">
          <div className="relative grid w-full gap-3 sm:p-4 lg:grid-cols-[1.02fr_0.98fr] lg:items-center xl:gap-10">
            <div className="rounded-[14px] border border-[color:var(--border)] bg-[linear-gradient(180deg,var(--hero-gradient)_0%,var(--brand)_100%)] p-3 sm:p-4 text-white shadow-[0_34px_90px_color-mix(in_srgb,var(--brand)_24%,transparent)]">
              ...
              <h1 className="mt-3 max-w-lg text-[clamp(1.5rem,4vw,2rem)] font-semibold leading-tight sm:mt-4">
            ...
            <form
              ...
              className="rounded-[12px] border border-[color:var(--border)] bg-[linear-gradient(180deg,color-mix(in_srgb,var(--bg-elevated)_82%,white)_0%,color-mix(in_srgb,var(--bg-surface)_70%,white)_100%)] p-4 shadow-[0_24px_50px_rgba(15,23,42,0.16)] backdrop-blur lg:p-3 sm:p-4"
            >
              <div className="mb-5">
                <p className="text-[11px] font-semibold uppercase tracking-[0.16em] text-[color:var(--fg-secondary)]">Owner sign up</p>
                <h2 className="mt-2 text-xl font-semibold text-[color:var(--fg-primary)] sm:text-2xl">Create account</h2>
