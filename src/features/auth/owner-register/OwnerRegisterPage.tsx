...
export default function OwnerRegisterPage() {
  ...
  return (
    <main className="h-dvh overflow-y-auto overscroll-y-contain bg-[linear-gradient(180deg,var(--bg-primary)_0%,color-mix(in_srgb,var(--bg-surface)_88%,white)_42%,color-mix(in_srgb,var(--bg-elevated)_85%,white)_100%)] px-4 py-3 text-[color:var(--fg-primary)] lg:px-6 lg:py-5">
