    ...
    <div className="smart-scroll-shell bg-[linear-gradient(180deg,var(--bg-primary)_0%,var(--bg-surface)_38%,var(--bg-elevated)_100%)] text-[color:var(--fg-primary)]">
      <div className="mx-auto flex min-h-full w-full max-w-[1400px]">
        <aside className="hidden h-full w-[260px] shrink-0 border-r border-[color:var(--border)] bg-[linear-gradient(180deg,var(--bg-surface)_0%,var(--bg-primary)_100%)] p-4 shadow-[0_24px_50px_rgba(0,0,0,0.18)] lg:block">
          <div className="mb-5 rounded-[10px] border border-[color:var(--border)] bg-[linear-gradient(180deg,var(--bg-elevated)_0%,color-mix(in_srgb,var(--bg-surface)_72%,black)_100%)] px-3 py-3">
            ...
            {nav.map((item) => {
              ...
              return (
                <Link
                  ...
                  href={item.href}
                  className={cn(
                    "flex items-center gap-2.5 rounded-[8px] px-3 py-2.5 text-sm font-medium transition",
        ...
        <div className="flex min-w-0 flex-1 flex-col overflow-hidden p-3 sm:p-4 lg:p-4">
          <header className="smart-scroll-header mb-2.5 flex items-center justify-between rounded-[10px] border border-[color:var(--border)] bg-[linear-gradient(180deg,color-mix(in_srgb,var(--bg-surface)_90%,white)_0%,var(--bg-surface)_100%)] px-4 py-3 shadow-sm">
            <div>
            ...
            <button
              ...
              className="inline-flex items-center gap-2 rounded-[8px] border border-[color:var(--border)] bg-[color:var(--bg-elevated)] px-3 py-2 text-sm font-semibold text-[color:var(--fg-primary)]"
            >
