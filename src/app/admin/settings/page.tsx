...
type AdminLog = { id: string; createdAt: string; event: string; detail: string };
...
export default function AdminSettingsPage() {
  ...
  const load = async () => {
    ...
    const featureData = (await featureRes.json()) as { features: Features };
    const logData = (await logsRes.json()) as { logs: AdminLog[] };
