  ...
  return (
    <main className="min-h-screen bg-[color:var(--bg-primary)] px-4 py-12 text-[color:var(--fg-primary)] sm:px-8">
      <div className="mx-auto w-full max-w-6xl space-y-8">
        <section className="rounded-[24px] border border-[color:var(--border)] bg-[linear-gradient(180deg,var(--bg-surface)_0%,var(--bg-primary)_100%)] p-8 shadow-[0_28px_70px_rgba(0,0,0,0.35)]">
        ...
        <section className="grid gap-8 lg:grid-cols-2">
          <div className="rounded-[24px] border border-[color:var(--border)] bg-[color:var(--bg-surface)] p-6">
        ...
        <section className="rounded-[24px] border border-[color:var(--border)] bg-[color:var(--bg-surface)] p-6">
