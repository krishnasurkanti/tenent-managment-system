...
export function OwnerMobileNav() {
  ...
  return (
    <nav className="fixed inset-x-0 bottom-0 z-50 border-t border-[color:var(--border)] bg-[linear-gradient(180deg,rgba(15,23,42,0.96)_0%,rgba(30,41,59,0.94)_100%)] px-2 pb-[calc(0.6rem+env(safe-area-inset-bottom))] pt-2 shadow-[0_-14px_34px_rgba(2,6,23,0.24)] backdrop-blur xl:hidden">
