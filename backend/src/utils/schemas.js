...
const tenantCreateSchema = z.object({
  ...
  monthlyRent: z.coerce.number().finite().nonnegative().max(10_000_000).optional(),
  rentPaid: z.coerce.number().finite().nonnegative().max(10_000_000).optional(),
  advanceAmount: z.coerce.number().finite().nonnegative().max(10_000_000).optional(),
  serviceFeeAmount: z.coerce.number().finite().nonnegative().max(10_000_000).optional(),
  advanceBalance: z.coerce.number().finite().nonnegative().max(10_000_000).optional(),
  serviceFeeCollected: z.coerce.number().finite().nonnegative().max(10_000_000).optional(),
