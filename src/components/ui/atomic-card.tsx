...
export function AtomicCard() {
  return (
    <article className="w-full max-w-sm overflow-hidden rounded-[18px] border border-[color:var(--border)] bg-[color:var(--bg-surface)] shadow-[0_24px_60px_rgba(0,0,0,0.32)]">
