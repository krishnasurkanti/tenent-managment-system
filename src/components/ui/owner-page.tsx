...
export function OwnerPageHero({
  ...
  return (
    <Card
      className={cn(
        "nestiq-grid-bg overflow-hidden border-white/8 bg-[radial-gradient(circle_at_top_right,rgba(99,102,241,0.22),transparent_30%),linear-gradient(180deg,#111114_0%,#09090b_100%)] p-3 sm:p-4",
        className,
      )}
    >
      <div className="flex min-w-0 flex-col gap-3 lg:flex-row lg:items-start lg:justify-between lg:gap-4">
        <div className="min-w-0 max-w-3xl">
          ...
          <h1 className="font-display mt-1 text-[clamp(1.25rem,4vw,2rem)] font-bold leading-tight text-white lg:mt-2">{title}</h1>
