...
function TrialModal({
  ...
  return (
    <div
      ...
      style={{
        position: "fixed", inset: 0, background: "rgba(5,5,8,.78)",
      ...
      <div style={{
        ...
        {!submitted ? (
          <>
            ...
            <h3 style={{ fontSize: "1.3rem", fontWeight: 800, letterSpacing: "-.03em", marginBottom: 4 }}>
              Start your{" "}
            ...
            <p style={{ fontSize: 12.5, color: "#71717a", lineHeight: 1.5, marginBottom: 18 }}>
              We'll contact you to activate your trial. Takes about 10 minutes.
            </p>
            <form
            ...
            >
              {[
                { label: "Full Name", type: "text", placeholder: "Raghuveer Reddy" },
              ].map((f) => (
                <div key={f.label} style={{ display: "flex", flexDirection: "column", gap: 5 }}>
                  <label style={{ fontSize: 10.5, fontWeight: 700, letterSpacing: ".16em", textTransform: "uppercase", color: "#71717a" }}>{f.label}</label>
                  <input
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
                {[
                  { label: "Phone", type: "tel", placeholder: "9876543210" },
                  { label: "Email", type: "email", placeholder: "you@hostel.com" },
                ].map((f) => (
                  <div key={f.label} style={{ display: "flex", flexDirection: "column", gap: 5 }}>
                    <label style={{ fontSize: 10.5, fontWeight: 700, letterSpacing: ".16em", textTransform: "uppercase", color: "#71717a" }}>{f.label}</label>
                    <input
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 5 }}>
                <label style={{ fontSize: 10.5, fontWeight: 700, letterSpacing: ".16em", textTransform: "uppercase", color: "#71717a" }}>Hostel / PG Name</label>
                <input required type="text" placeholder="e.g. Sai Krishna PG"
                  style={{ background: "rgba(255,255,255,.04)", border: "1px solid rgba(255,255,255,.08)", borderRadius: 8, padding: "10px 12px", fontSize: 13.5, color: "#f4f4f5", fontFamily: "inherit", outline: "none" }}
                />
              </div>
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
                <div style={{ display: "flex", flexDirection: "column", gap: 5 }}>
                  <label style={{ fontSize: 10.5, fontWeight: 700, letterSpacing: ".16em", textTransform: "uppercase", color: "#71717a" }}>Rooms / Beds</label>
                  <input type="text" placeholder="12 / 36"
                    style={{ background: "rgba(255,255,255,.04)", border: "1px solid rgba(255,255,255,.08)", borderRadius: 8, padding: "10px 12px", fontSize: 13.5, color: "#f4f4f5", fontFamily: "inherit", outline: "none" }}
                  />
                </div>
                <div style={{ display: "flex", flexDirection: "column", gap: 5 }}>
                  <label style={{ fontSize: 10.5, fontWeight: 700, letterSpacing: ".16em", textTransform: "uppercase", color: "#71717a" }}>Plan</label>
              ...
              <button type="submit" style={{
                ...
                boxShadow: "0 10px 24px rgba(251,191,36,.3)",
              }}>
                Request Trial →
              </button>
          ...
          <div style={{ textAlign: "center", padding: "18px 0" }}>
            ...
            <div style={{ fontSize: "1.15rem", fontWeight: 800, letterSpacing: "-.02em", marginBottom: 6 }}>Thanks! Request received.</div>
...
export default function HomePage() {
  ...
  const [modalPlan, setModalPlan] = useState("Growth");
  const [navOpen, setNavOpen] = useState(false);
  const carouselRef = useRef<HTMLDivElement>(null);
  const [dotIdx, setDotIdx] = useState(0);

  const openModal = useCallback((plan = "Growth") => {
    setModalPlan(plan);
    setModalOpen(true);
  }, []);
  ...
  const scrollCarousel = (dir: -1 | 1) => {
    carouselRef.current?.scrollBy({ left: dir * 374, behavior: "smooth" });
  };
  ...
  return (
    <>
      <style>{`
        ...
        .lp-video-card:hover{transform:translateY(-3px);border-color:rgba(99,102,241,.32)!important}
        ...
        @media(max-width:1024px){.lp-nav-links{display:none!important}.lp-nav-toggle{display:flex!important}.lp-hero-grid{grid-template-columns:1fr!important}.lp-hero-illus{height:320px!important;order:-1}.lp-problems-grid{grid-template-columns:repeat(2,1fr)!important}.lp-flow-row{grid-template-columns:repeat(4,1fr)!important}.lp-metrics-grid{grid-template-columns:1fr!important}.lp-pricing-grid{grid-template-columns:1fr!important}.lp-price-featured{transform:none!important}.lp-vid-card{flex:0 0 300px!important}}
        @media(max-width:640px){.lp-hero-inner{padding:0 16px!important}.lp-tab-inner{padding:0 16px!important}.lp-problems-grid{grid-template-columns:1fr!important}.lp-flow-row{grid-template-columns:repeat(2,1fr)!important}.lp-vid-card{flex:0 0 calc(100vw - 56px)!important}.lp-footer-inner{flex-direction:column!important;text-align:center!important}}
      `}</style>

      {/* NAV */}
      <nav style={{
        position: "sticky", top: 0, zIndex: 60,
        background: "rgba(9,9,11,.84)", backdropFilter: "blur(20px)",
        ...
        <div style={{
          ...
          {/* Logo */}
          <div style={{ display: "flex", alignItems: "center", gap: 9, fontSize: 16, fontWeight: 800, letterSpacing: "-.02em" }}>
            <div style={{
          ...
          {/* Desktop links */}
          <div className="lp-nav-links" style={{ display: "flex", alignItems: "center", gap: 24, fontSize: 13, fontWeight: 500, color: "#a1a1aa" }}>
            {[["Problem","problem"],["Solution","solution"],["Demos","demos"],["Pricing","pricing"]].map(([label, t]) => (
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
            <Link href="/owner/login" style={{
              ...
              borderRadius: 8, padding: "7px 14px", fontSize: 13, fontWeight: 600, color: "#f4f4f5",
              textDecoration: "none",
            }}>
              Owner Login
            </Link>
            <button onClick={() => openModal()} style={{
              ...
              padding: "8px 16px", fontSize: 13, fontWeight: 700, color: "#1f1408",
              boxShadow: "0 6px 16px rgba(251,191,36,.3)", border: "none", cursor: "pointer",
            }}>
              Watch Demo
            </button>
            {/* Mobile toggle */}
      ...
      {/* HERO */}
      <section style={{
        position: "relative", overflow: "hidden", padding: "36px 0 42px",
        ...
        {/* orb glow BL */}
        <div style={{
          position: "absolute", bottom: -120, left: -100, width: 400, height: 400,
          borderRadius: "50%", background: "radial-gradient(circle,rgba(20,184,166,.1) 0%,transparent 60%)",
          pointerEvents: "none",
        }}/>
        ...
        <div
          ...
          style={{
            position: "relative", maxWidth: 1280, margin: "0 auto", padding: "0 28px",
            display: "grid", gridTemplateColumns: "1.1fr .9fr", gap: 48, alignItems: "center", zIndex: 2,
          }}
        >
          {/* Left copy */}
          <div className="lp-hero-inner">
            <div style={{ display: "inline-flex", alignItems: "center", gap: 7, fontSize: 10.5, fontWeight: 700, letterSpacing: ".22em", textTransform: "uppercase" as const, color: "#818cf8", marginBottom: 18 }}>
              <LiveDot /> Trusted by 42 hostels · 1,240 tenants
            </div>
            <h1 style={{ fontSize: "clamp(1.9rem,3.6vw,3.1rem)", fontWeight: 800, letterSpacing: "-.045em", lineHeight: 1.05, marginBottom: 14 }}>
              <span style={{ background: "linear-gradient(135deg,#fff 0%,#c7d2fe 50%,#818cf8 100%)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>Save money on every </span>
              <span style={{ background: "linear-gradient(135deg,#fde047,#fbbf24,#f59e0b)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>room, tenant &amp; rent</span>
              <span style={{ background: "linear-gradient(135deg,#fff 0%,#c7d2fe 50%,#818cf8 100%)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}> payment.</span>
            </h1>
            <p style={{ fontSize: 14.5, color: "#a1a1aa", lineHeight: 1.55, marginBottom: 22, maxWidth: 520 }}>
              Stop revenue leaks, track vacant beds, collect rent on time, and replace paper work with a live operating dashboard.
            </p>
            ...
            <div style={{ display: "flex", flexWrap: "wrap" as const, gap: 10, alignItems: "center" }}>
              <button
                ...
                style={{
                  ...
                  boxShadow: "0 10px 24px rgba(251,191,36,.32)", border: "none", cursor: "pointer",
              ...
              <button onClick={() => { setTab("pricing"); document.getElementById("tabs")?.scrollIntoView({ behavior: "smooth" }); }}
                style={{ background: "none", border: "none", color: "#a1a1aa", fontSize: 13, fontWeight: 600, cursor: "pointer", padding: "6px 4px" }}>
                See Pricing →
              </button>
            </div>

            <div style={{ marginTop: 18, display: "flex", alignItems: "center", gap: 7, fontSize: 11, color: "#71717a" }}>
              <LiveDot />
          ...
          {/* Right illustration */}
          <div className="lp-hero-illus" style={{ position: "relative", height: 400, display: "flex", alignItems: "flex-end", justifyContent: "center" }}>
            {/* Ground ellipse */}
            ...
            {[
              ...
              { text: "No missed payments", color: "teal", style: { bottom: "8%", left: "-4%", animation: "float-a 4.4s ease-in-out infinite alternate" } as React.CSSProperties },
              ...
              const chipColors: Record<string, { bg: string; border: string; color: string }> = {
                ...
                teal: { bg: "rgba(20,184,166,.16)", border: "rgba(20,184,166,.32)", color: "#5eead4" },
              };
              const c = chipColors[color];
              return (
                <div key={text} style={{
                  position: "absolute", display: "inline-flex", alignItems: "center", gap: 5,
                  padding: "6px 11px", borderRadius: 999, fontSize: 10.5, fontWeight: 700,
            ...
            <div style={{
              ...
              zIndex: 6, width: 175, borderRadius: 10,
              ...
              <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 8 }}>
                <span style={{ fontSize: 9.5, fontWeight: 700, letterSpacing: ".18em", textTransform: "uppercase" as const, color: "#c7d2fe" }}>Live OS</span>
                <LiveDot />
              </div>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 3 }}>
                {[
                  ...
                  <div key={l} style={{ background: "rgba(255,255,255,.04)", borderRadius: 5, padding: "4px 5px", textAlign: "center" as const }}>
                    <div style={{ fontSize: 12, fontWeight: 800, letterSpacing: "-.02em", lineHeight: 1, color }}>{v}</div>
                    <div style={{ fontSize: 8, fontWeight: 600, letterSpacing: ".12em", textTransform: "uppercase" as const, color: "#52525b", marginTop: 2 }}>{l}</div>
                  </div>
                ))}
              </div>
            </div>
            ...
            <svg width="100%" height="100%" viewBox="0 0 540 540" fill="none" xmlns="http://www.w3.org/2000/svg"
              style={{ maxWidth: 480, position: "relative", zIndex: 1 }} preserveAspectRatio="xMidYMax meet">
              <defs>
              ...
              <rect x="65" y="234" width="14" height="9" rx="1.5" fill="#6366f1" className="win-c" opacity=".4" transform="skewY(26)"/>
              <rect x="85" y="223" width="14" height="9" rx="1.5" fill="#818cf8" className="win-a" opacity=".7" transform="skewY(26)"/>
              ...
              <rect x="65" y="290" width="14" height="9" rx="1.5" fill="#818cf8" className="win-d" opacity=".48" transform="skewY(26)"/>
              <rect x="85" y="279" width="14" height="9" rx="1.5" fill="#6366f1" className="win-f" opacity=".6" transform="skewY(26)"/>
              ...
              <rect x="65" y="346" width="14" height="9" rx="1.5" fill="#22c55e" className="win-e" opacity=".7" transform="skewY(26)"/>
              <rect x="85" y="335" width="14" height="9" rx="1.5" fill="#818cf8" className="win-b" opacity=".55" transform="skewY(26)"/>
              {/* back-right */}
              ...
              <rect x="425" y="140" width="15" height="10" rx="1.5" fill="#6366f1" className="win-c" opacity=".55" transform="skewY(22)"/>
              <rect x="448" y="128" width="15" height="10" rx="1.5" fill="#22c55e" className="win-e" opacity=".75" transform="skewY(22)"/>
              <rect x="470" y="116" width="15" height="10" rx="1.5" fill="#818cf8" className="win-a" opacity=".62" transform="skewY(22)"/>
              <rect x="425" y="170" width="15" height="10" rx="1.5" fill="#6366f1" className="win-d" opacity=".4" transform="skewY(22)"/>
              <rect x="448" y="158" width="15" height="10" rx="1.5" fill="#6366f1" className="win-f" opacity=".82" transform="skewY(22)"/>
              <rect x="470" y="146" width="15" height="10" rx="1.5" fill="#22c55e" className="win-b" opacity=".58" transform="skewY(22)"/>
              ...
              <rect x="470" y="176" width="15" height="10" rx="1.5" fill="#6366f1" className="win-e" opacity=".45" transform="skewY(22)"/>
              ...
              <rect x="470" y="206" width="15" height="10" rx="1.5" fill="#818cf8" className="win-f" opacity=".55" transform="skewY(22)"/>
              <rect x="425" y="260" width="15" height="10" rx="1.5" fill="#ef4444" className="win-a" opacity=".68" transform="skewY(22)"/>
              <rect x="448" y="248" width="15" height="10" rx="1.5" fill="#22c55e" className="win-c" opacity=".75" transform="skewY(22)"/>
              <rect x="470" y="236" width="15" height="10" rx="1.5" fill="#22c55e" className="win-e" opacity=".82" transform="skewY(22)"/>
              <rect x="425" y="290" width="15" height="10" rx="1.5" fill="#6366f1" className="win-b" opacity=".42" transform="skewY(22)"/>
              <rect x="448" y="278" width="15" height="10" rx="1.5" fill="#818cf8" className="win-d" opacity=".66" transform="skewY(22)"/>
              <rect x="425" y="320" width="15" height="10" rx="1.5" fill="#22c55e" className="win-f" opacity=".8" transform="skewY(22)"/>
              <rect x="448" y="308" width="15" height="10" rx="1.5" fill="#6366f1" className="win-a" opacity=".55" transform="skewY(22)"/>
              {/* main front building */}
              ...
              <line x1="160" y1="128" x2="270" y2="80" stroke="rgba(129,140,248,.4)" strokeWidth="1.2"/>
              <line x1="270" y1="80" x2="380" y2="32" stroke="rgba(129,140,248,.28)" strokeWidth="1.2"/>
              {/* right face windows */}
              ...
              <rect x="346" y="32" width="24" height="15" rx="2" fill="#22c55e" className="win-e" opacity=".92" transform="skewY(22)"/>
              <rect x="278" y="138" width="24" height="15" rx="2" fill="#6366f1" className="win-a" opacity=".62" transform="skewY(22)"/>
              <rect x="312" y="124" width="24" height="15" rx="2" fill="#22c55e" className="win-d" opacity=".88" transform="skewY(22)"/>
              <rect x="346" y="110" width="24" height="15" rx="2" fill="#ef4444" className="win-f" opacity=".75" transform="skewY(22)"/>
              ...
              <rect x="278" y="290" width="24" height="15" rx="2" fill="#f59e0b" className="win-c" opacity=".78" transform="skewY(22)"/>
              <rect x="312" y="276" width="24" height="15" rx="2" fill="#22c55e" className="win-d" opacity=".88" transform="skewY(22)"/>
              <rect x="346" y="262" width="24" height="15" rx="2" fill="#6366f1" className="win-f" opacity=".48" transform="skewY(22)"/>
              {/* left face windows */}
              <rect x="168" y="148" width="26" height="16" rx="2" fill="#22c55e" className="win-f" opacity=".82" transform="skewY(-22)"/>
              <rect x="202" y="134" width="26" height="16" rx="2" fill="#f59e0b" className="win-a" opacity=".72" transform="skewY(-22)"/>
              <rect x="236" y="120" width="26" height="16" rx="2" fill="#22c55e" className="win-c" opacity=".9" transform="skewY(-22)"/>
              ...
              <rect x="202" y="286" width="26" height="16" rx="2" fill="#818cf8" className="win-c" opacity=".62" transform="skewY(-22)"/>
              <rect x="236" y="272" width="26" height="16" rx="2" fill="#22c55e" className="win-f" opacity=".82" transform="skewY(-22)"/>
              {/* antenna */}
              ...
              {/* connection lines */}
              <path d="M 80 280 Q 180 320 250 320" stroke="rgba(99,102,241,.35)" strokeWidth="1.3" fill="none" strokeDasharray="3 4" strokeLinecap="round"/>
              <path d="M 460 220 Q 380 280 310 305" stroke="rgba(99,102,241,.35)" strokeWidth="1.3" fill="none" strokeDasharray="3 4" strokeLinecap="round"/>
            </svg>
          </div>
        </div>
      </section>
      ...
      {/* TABBED SECTION */}
      <section id="tabs" style={{ padding: "40px 0 48px", borderTop: "1px solid rgba(255,255,255,.07)", background: "#09090b" }}>
        <div className="lp-tab-inner" style={{ maxWidth: 1280, margin: "0 auto", padding: "0 28px" }}>
          ...
          <div className="lp-tabbar" style={{
            ...
            borderRadius: 12, maxWidth: 680, marginLeft: "auto", marginRight: "auto",
            ...
            {([
              ...
              <button key={t} onClick={() => setTab(t)} style={tabBtnStyle(t)}>
                ...
                {badge && (
                  <span style={{
                    fontSize: 9.5, fontWeight: 800, letterSpacing: ".1em", padding: "2px 6px", borderRadius: 4,
          ...
          {tab === "problem" && (
            <div>
              <div style={{ textAlign: "center", marginBottom: 22 }}>
                <div style={{ display: "inline-flex", alignItems: "center", gap: 7, fontSize: 10.5, fontWeight: 700, letterSpacing: ".22em", textTransform: "uppercase" as const, color: "#fca5a5", marginBottom: 10 }}>
                  <LiveDot color="red" /> The Hidden Leaks
                </div>
                <h2 style={{ fontSize: "clamp(1.4rem,2.4vw,1.9rem)", fontWeight: 800, letterSpacing: "-.035em", lineHeight: 1.15 }}>
                  Hostel owners lose money in{" "}
                  <span style={{ background: "linear-gradient(135deg,#f87171,#fbbf24)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>small places</span>
                  {" "}every week.
                </h2>
              </div>
              <div className="lp-problems-grid" style={{ display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: 12 }}>
                {[
                  ...
                  <div key={n} className="lp-card-hover" style={{
                    ...
                    border: "1px solid rgba(239,68,68,.18)", borderRadius: 10, padding: "18px 16px",
                    position: "relative", overflow: "hidden",
                  }}>
                    <div style={{ position: "absolute", top: 0, left: 0, right: 0, height: 2, background: "linear-gradient(90deg,#ef4444,#f59e0b)" }}/>
                    <div style={{ fontSize: 10, fontWeight: 700, letterSpacing: ".18em", textTransform: "uppercase" as const, color: "#f87171", marginBottom: 10 }}>Problem {n}</div>
                    <div style={{ fontSize: 13.5, fontWeight: 700, color: "#f4f4f5", lineHeight: 1.3, marginBottom: 6 }}>{title}</div>
                    <div style={{ fontSize: 12, color: "#71717a", lineHeight: 1.5 }}>{desc}</div>
                    <div style={{ marginTop: 10, paddingTop: 10, borderTop: "1px dashed rgba(239,68,68,.18)", fontSize: 10.5, color: "#f87171", fontWeight: 700 }}>↗ {cost}</div>
                  </div>
                ))}
              </div>
            </div>
          ...
          {tab === "solution" && (
            <div>
              <div style={{ textAlign: "center", marginBottom: 24 }}>
                <div style={{ display: "inline-flex", alignItems: "center", gap: 7, fontSize: 10.5, fontWeight: 700, letterSpacing: ".22em", textTransform: "uppercase" as const, color: "#818cf8", marginBottom: 10 }}>
              ...
              <div className="lp-flow-row" style={{ display: "grid", gridTemplateColumns: "repeat(7,1fr)", gap: 6, width: "100%" }}>
                {[
                  "Create Hostel","Add Rooms","Add Tenant","Assign Bed","Collect Rent","Track Due","View Reports"
                ].map((label, i) => (
                  <div key={label} className="lp-card-hover" style={{
                    ...
                    <div style={{
                      ...
                      fontSize: 10, fontWeight: 800, color: "#fff", boxShadow: "0 4px 10px rgba(99,102,241,.5)",
                    }}>{i + 1}</div>
          ...
          {tab === "metrics" && (
            <div>
              <div style={{ textAlign: "center", marginBottom: 24 }}>
                <div style={{ display: "inline-flex", alignItems: "center", gap: 7, fontSize: 10.5, fontWeight: 700, letterSpacing: ".22em", textTransform: "uppercase" as const, color: "#4ade80", marginBottom: 10 }}>
                  <LiveDot color="green" /> Money Saved · Real Owners
                </div>
                <h2 style={{ fontSize: "clamp(1.4rem,2.4vw,1.9rem)", fontWeight: 800, letterSpacing: "-.035em", lineHeight: 1.15 }}>
                  Numbers that move the bottom line.
                </h2>
              </div>
              <div className="lp-metrics-grid" style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 14 }}>
                {[
                  ...
                  <div key={title} className="lp-card-hover" style={{
                    ...
                    border: "1px solid rgba(20,184,166,.2)", borderRadius: 12, padding: "22px 22px",
                    position: "relative", overflow: "hidden",
                  }}>
                    <div style={{ position: "absolute", top: 0, left: 0, right: 0, height: 2, background: "linear-gradient(90deg,#14b8a6,#22c55e)" }}/>
                    <div style={{ fontSize: "clamp(1.8rem,3vw,2.6rem)", fontWeight: 800, letterSpacing: "-.05em", lineHeight: 1, background: "linear-gradient(135deg,#fff,#5eead4)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", marginBottom: 6 }}>
                      {val}<span style={{ fontSize: ".5em", fontWeight: 700, color: "#14b8a6", WebkitTextFillColor: "#14b8a6", marginLeft: 3, letterSpacing: 0 }}>{unit}</span>
                    </div>
                    <div style={{ fontSize: 14, fontWeight: 700, color: "#f4f4f5", marginBottom: 4 }}>{title}</div>
                    <div style={{ fontSize: 12, color: "#71717a", lineHeight: 1.45 }}>{desc}</div>
                    <div style={{ marginTop: 14, height: 5, borderRadius: 999, background: "rgba(255,255,255,.05)", overflow: "hidden" }}>
                      <div style={{ height: "100%", width: `${bar}%`, borderRadius: 999, background: "linear-gradient(90deg,#14b8a6,#22c55e)", boxShadow: "0 0 8px #14b8a6" }}/>
                    </div>
                  </div>
                ))}
              </div>
          ...
          {tab === "demos" && (
            <div>
              <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 16, marginBottom: 18 }}>
                <div>
                  <div style={{ display: "inline-flex", alignItems: "center", gap: 7, fontSize: 10.5, fontWeight: 700, letterSpacing: ".22em", textTransform: "uppercase" as const, color: "#fcd34d", marginBottom: 8 }}>
                    <LiveDot color="amber" /> See it in action
                  </div>
                  <h2 style={{ fontSize: "clamp(1.4rem,2.4vw,1.9rem)", fontWeight: 800, letterSpacing: "-.03em", lineHeight: 1.15 }}>
                    4 walkthroughs, daily moments.
                  </h2>
                </div>
                <div style={{ display: "flex", gap: 6, flexShrink: 0 }}>
                  {([-1,1] as const).map(dir => (
                    <button key={dir} onClick={() => scrollCarousel(dir)} style={{
                      width: 38, height: 38, borderRadius: "50%", background: "rgba(255,255,255,.05)",
              ...
              <div ref={carouselRef} className="lp-carousel" style={{
                display: "flex", gap: 14, overflowX: "auto" as const, overflowY: "hidden",
                scrollSnapType: "x mandatory", scrollBehavior: "smooth", padding: "4px 0",
                WebkitOverflowScrolling: "touch" as const,
              }}>
                {[
                  { n: "01", title: "Owner setup walkthrough", dur: "2:14", bullets: ["Create a hostel in under 60 sec","Add floors, rooms & beds in one form","Set rent, deposit & sharing"] },
                  { n: "02", title: "Tenant management walkthrough", dur: "3:42", bullets: ["Add tenant in 4 fields","Assign to a bed with one tap","Update / remove instantly"] },
                  { n: "03", title: "Rent collection walkthrough", dur: "2:58", bullets: ["Record payments in seconds","See due & overdue live","Full payment history"] },
                  { n: "04", title: "Reports & weekly insights", dur: "2:30", bullets: ["Weekly cash flow at a glance","Occupancy + collection trends","Export Excel / PDF anytime"] },
                ].map(({ n, title, dur, bullets }) => (
                  <div key={n} className="lp-vid-card lp-video-card" onClick={() => openModal()} style={{
                    ...
                    <div style={{
                      ...
                      <div style={{
                        position: "absolute", inset: 12, border: "1px solid rgba(255,255,255,.06)",
                        borderRadius: 7, background: "rgba(13,13,18,.4)", padding: 7,
                        display: "flex", flexDirection: "column", gap: 5,
                      }}>
                        <div style={{ height: 5, borderRadius: 3, background: "linear-gradient(90deg,#6366f1,#818cf8)", width: "62%" }}/>
                        <div style={{ height: 5, borderRadius: 3, background: "rgba(255,255,255,.08)" }}/>
                        <div style={{ height: 5, borderRadius: 3, background: "rgba(255,255,255,.08)", width: "50%" }}/>
                      ...
                      <div className="lp-video-play" style={{
                        ...
                        <svg width="17" height="17" viewBox="0 0 24 24" fill="#1f1408"><polygon points="5 3 19 12 5 21 5 3"/></svg>
                      </div>
                      <div style={{
                        position: "absolute", top: 9, right: 9, background: "rgba(0,0,0,.7)",
                        backdropFilter: "blur(6px)", padding: "2px 7px", borderRadius: 5,
                        fontSize: 10.5, fontWeight: 600, color: "#fff", zIndex: 2,
                        fontFamily: "monospace",
                      }}>{dur}</div>
                    </div>
                    {/* body */}
                    <div style={{ padding: "16px 18px" }}>
                      <div style={{ fontSize: 9.5, fontWeight: 700, letterSpacing: ".2em", textTransform: "uppercase" as const, color: "#fcd34d", marginBottom: 8 }}>Demo {n}</div>
                      <div style={{ fontSize: 14, fontWeight: 700, color: "#f4f4f5", marginBottom: 10, lineHeight: 1.3 }}>{title}</div>
                      <div style={{ display: "flex", flexDirection: "column", gap: 5 }}>
                        {bullets.map(b => (
                          <div key={b} style={{ display: "flex", alignItems: "flex-start", gap: 6, fontSize: 11.5, color: "#a1a1aa", lineHeight: 1.4 }}>
              ...
              <div style={{ display: "flex", gap: 5, justifyContent: "center", marginTop: 14 }}>
                {[0,1,2,3].map(i => (
                  <button key={i} onClick={() => carouselRef.current?.scrollTo({ left: i * 374, behavior: "smooth" })} style={{
                    width: dotIdx === i ? 22 : 6, height: 6, borderRadius: 999, border: "none", cursor: "pointer",
          ...
          {tab === "pricing" && (
            <div id="pricing">
              <div style={{ textAlign: "center", marginBottom: 18 }}>
                <div style={{ display: "inline-flex", alignItems: "center", gap: 7, fontSize: 10.5, fontWeight: 700, letterSpacing: ".22em", textTransform: "uppercase" as const, color: "#fcd34d", marginBottom: 10 }}>
              ...
              <div style={{
                display: "flex", alignItems: "center", justifyContent: "space-between", gap: 14,
                flexWrap: "wrap" as const, padding: "14px 20px", marginBottom: 24, borderRadius: 12,
                background: "linear-gradient(135deg,rgba(251,191,36,.16),rgba(245,158,11,.08))",
                border: "1px solid rgba(251,191,36,.32)", position: "relative", overflow: "hidden",
              }}>
                <div style={{
                  width: 38, height: 38, borderRadius: 9, background: "linear-gradient(135deg,#fbbf24,#f59e0b)",
                  display: "flex", alignItems: "center", justifyContent: "center", color: "#1f1408", flexShrink: 0,
                  boxShadow: "0 6px 18px rgba(251,191,36,.4)",
                }}>
                ...
                <div style={{ flex: 1, minWidth: 200 }}>
                  <div style={{ fontSize: 10, fontWeight: 700, letterSpacing: ".2em", textTransform: "uppercase" as const, color: "#fbbf24", marginBottom: 2 }}>Launch Offer</div>
                  <div style={{ fontSize: 15, fontWeight: 800, color: "#f4f4f5", letterSpacing: "-.02em", lineHeight: 1.3 }}>First 30 days free · No setup fee for early owners</div>
                </div>
                <button onClick={() => openModal("Starter")} style={{
                  ...
                  boxShadow: "0 8px 20px rgba(251,191,36,.32)",
                }}>Claim →</button>
              </div>

              {/* pricing grid */}
              <div className="lp-pricing-grid" style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 14, alignItems: "stretch" }}>
                {[
                  {
                    ...
                    ctaStyle: "ghost", plan: "Starter",
                    features: ["Up to 50 monthly tenants","1 hostel","Room & bed tracking","Rent due reminders","Rs 10 per extra tenant"],
                  },
                  {
                    ...
                    ctaStyle: "gold", plan: "Growth",
                    features: ["Up to 150 monthly tenants","3 hostels","Payment tracking + receipts","Due & overdue live dashboard","Rs 7 per extra tenant","Rs 199 per extra hostel"],
                  },
                  {
                    ...
                    ctaStyle: "indigo", plan: "Pro",
                    features: ["Up to 300 monthly tenants","5 hostels","Advanced reports","Backup & export","Rs 5 per extra tenant","Rs 199 per extra hostel"],
                  },
                  ...
                  <div key={tier} className={featured ? "lp-price-featured" : "lp-card-hover"} style={{
                    background: featured
                      ? "linear-gradient(180deg,rgba(99,102,241,.1),rgba(99,102,241,.02))"
                    ...
                    <div style={{ fontSize: 11, fontWeight: 700, letterSpacing: ".18em", textTransform: "uppercase" as const, color: featured ? "#fcd34d" : "#818cf8", marginBottom: 6 }}>{tier}</div>
                    <div style={{ fontSize: 12, color: "#71717a", lineHeight: 1.45, marginBottom: 16 }}>{desc}</div>
                    <div style={{ display: "flex", alignItems: "baseline", gap: 5, marginBottom: 4 }}>
                      <span style={{ fontSize: "2rem", fontWeight: 800, letterSpacing: "-.05em", color: "#f4f4f5", lineHeight: 1 }}>{price}</span>
                      {period && <span style={{ fontSize: 12, color: "#71717a", fontWeight: 600 }}>{period}</span>}
                    </div>
                    <div style={{ fontSize: 11, color: "#4ade80", fontWeight: 600, marginBottom: 16 }}>{trial}</div>
                    <ul style={{ listStyle: "none", display: "flex", flexDirection: "column", gap: 8, marginBottom: 18, flex: 1 }}>
                      {features.map(f => (
                        <li key={f} style={{ display: "flex", alignItems: "flex-start", gap: 7, fontSize: 12.5, color: "#a1a1aa", lineHeight: 1.4 }}>
              ...
              <div style={{ textAlign: "center", marginTop: 18, fontSize: 11.5, color: "#52525b" }}>
      ...
      {/* FINAL CTA */}
      <section style={{
        padding: "64px 28px", textAlign: "center", borderTop: "1px solid rgba(255,255,255,.07)",
        background: "radial-gradient(ellipse 60% 50% at 50% 50%,rgba(99,102,241,.12),transparent 65%),#09090b",
      }}>
        <div style={{ display: "inline-flex", alignItems: "center", gap: 7, fontSize: 10.5, fontWeight: 700, letterSpacing: ".22em", textTransform: "uppercase" as const, color: "#818cf8", marginBottom: 14 }}>
          <LiveDot /> Ready in 10 Minutes
        </div>
        <h2 style={{ fontSize: "clamp(1.6rem,3vw,2.4rem)", fontWeight: 800, letterSpacing: "-.04em", lineHeight: 1.1, marginBottom: 12, maxWidth: 620, marginLeft: "auto", marginRight: "auto" }}>
        ...
        <p style={{ fontSize: 14, color: "#a1a1aa", maxWidth: 480, margin: "0 auto 22px" }}>
        ...
        <div style={{ display: "flex", flexWrap: "wrap" as const, gap: 8, justifyContent: "center" }}>
          <button onClick={() => openModal()} className="lp-btn-primary" style={{
            background: "linear-gradient(135deg,#fbbf24,#f59e0b)", borderRadius: 9,
            padding: "12px 22px", fontSize: 13.5, fontWeight: 700, color: "#1f1408",
            boxShadow: "0 10px 24px rgba(251,191,36,.32)", border: "none", cursor: "pointer",
      ...
      {/* FOOTER */}
      <footer style={{ borderTop: "1px solid rgba(255,255,255,.07)", padding: "24px 28px", background: "#0d0d12", fontSize: 12, color: "#52525b" }}>
          ...
          <div style={{ display: "flex", gap: 18, alignItems: "center" }}>
            {[["Problem",()=>{ setTab("problem"); document.getElementById("tabs")?.scrollIntoView({behavior:"smooth"}); }],
              ...
              <button key={label as string} onClick={fn as ()=>void} className="lp-footer-link"
                style={{ background: "none", border: "none", color: "#71717a", cursor: "pointer", fontSize: 12.5 }}>
                {label as string}
              </button>
            ))}
            <Link href="/owner/login" className="lp-footer-link" style={{ color: "#71717a", textDecoration: "none", fontSize: 12.5 }}>Owner Login</Link>
          </div>
        </div>
      </footer>
