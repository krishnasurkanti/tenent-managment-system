...
export default function LoginPage() {
  ...
  return (
    <main className="h-dvh overflow-x-hidden overflow-y-auto overscroll-contain bg-[#090912] px-2 py-2 text-white sm:px-4 sm:py-4 lg:px-6 lg:py-6">
      <div className="relative mx-auto flex min-h-[calc(100vh-1rem)] min-h-[calc(100dvh-1rem)] w-full max-w-7xl flex-1 flex-col overflow-hidden rounded-[8px] border border-white/10 bg-[radial-gradient(circle_at_20%_38%,rgba(33,76,142,0.22),transparent_22%),radial-gradient(circle_at_56%_72%,rgba(245,168,39,0.18),transparent_18%),linear-gradient(180deg,#0d0f1a_0%,#090b14_100%)] shadow-[0_36px_100px_rgba(0,0,0,0.42)] sm:min-h-[calc(100vh-2rem)] sm:min-h-[calc(100dvh-2rem)] lg:rounded-[10px]">
          ...
          <div className="hidden lg:flex lg:flex-col lg:justify-start lg:pt-2">
            <div className="max-w-xl">
              <div className="inline-flex items-center gap-3">
                ...
                <div>
                  <p className="text-xl font-semibold leading-none text-[#f6f0e8]">Tenant</p>
              ...
              <div className="rounded-[10px] border border-[#253556] bg-[linear-gradient(180deg,rgba(12,17,34,0.96)_0%,rgba(8,11,22,0.96)_100%)] p-4 shadow-[0_28px_60px_rgba(0,0,0,0.32)]">
                ...
                <div className="mt-3 grid gap-3 xl:grid-cols-[190px_minmax(0,1fr)]">
                  <div className="rounded-[8px] border border-white/8 bg-white/[0.03] p-3.5">
                    <div className="text-[10px] font-semibold uppercase tracking-[0.14em] text-white/32">Collections</div>
                    <div className="mt-2 text-2xl font-semibold text-[#f7f0e8]">Rs 52,500</div>
                    <div className="mt-3 space-y-2">
                      <PreviewStat label="Due Soon" value="1" tone="yellow" />
                      <PreviewStat label="Overdue" value="4" tone="red" />
                    </div>
                  </div>
                  <div className="rounded-[8px] border border-white/8 bg-white/[0.03] p-3.5">
                    <div className="text-[10px] font-semibold uppercase tracking-[0.14em] text-white/32">Occupancy Trend</div>
                    <div className="mt-3 flex items-end gap-2">
                      {[26, 38, 34, 49, 63, 56, 68].map((value, index) => (
                        <div key={index} className="flex-1 rounded-t-[12px] bg-[linear-gradient(180deg,#325594_0%,#49b9d8_100%)]" style={{ height: `${value}px` }} />
                      ))}
                    </div>
                    <div className="mt-4 grid grid-cols-3 gap-2">
                      <MetricPill value="18" label="Rooms" />
                      <MetricPill value="124" label="Tenants" />
                      <MetricPill value="4" label="Due" />
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="rounded-[8px] border border-white/12 bg-[linear-gradient(180deg,rgba(18,22,38,0.92)_0%,rgba(15,17,31,0.96)_100%)] p-3.5 shadow-[0_30px_80px_rgba(0,0,0,0.4)] backdrop-blur-xl sm:p-5 lg:rounded-[10px] lg:p-5 xl:p-6">
                <div className="lg:hidden">
                  <div className="flex items-center gap-2.5">
                    ...
                    <div>
                      <p className="text-sm font-semibold leading-none text-[#f6f0e8]">Tenant</p>
                ...
                <div className="mt-3 text-center lg:mt-0">
                  ...
                  <p className="mt-1 text-sm text-white/45 sm:text-base">Login to your account</p>
                </div>
                ...
                <form onSubmit={handleLogin} className="mt-4 space-y-2.5 sm:mt-5 sm:space-y-3">
                  ...
                  <button
                    ...
                    disabled={loading || demoLoading}
                    className="inline-flex min-h-10 w-full items-center justify-center rounded-2xl border border-white/10 bg-white/[0.03] px-4 text-sm font-semibold text-white/78 transition hover:bg-white/[0.06] sm:min-h-11"
                  >
...
function PreviewStat({
  ...
  return (
    <div className={`flex items-center justify-between rounded-2xl px-3 py-2 ${tone === "yellow" ? "bg-[#3a311f] text-[#ffd15a]" : "bg-[#3a1a1f] text-[#ff7a7a]"}`}>
